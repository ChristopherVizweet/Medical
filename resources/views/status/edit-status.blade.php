<x-guest-layout>
    <form method="POST" action="{{ route('edit-status', $statuses->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mt-4">
            ...
            <x-text-input id="nameStatus" class="block mt-1 w-full" type="text" name="nameStatus" value="{{ $statuses->nameStatus }}" required />
        </div>
