<x-app-layout>
    ...
    <div class="container mx-auto mt-4">
        ...
        <x-primary-button class="mt-4">
         ...
         <x-primary-button class="mt-4">
            <a href="{{ route('checadas.index') }}" class="text-dark">
                {{ __('Check IN') }}
            </a>
        </x-primary-button>
            ...
            <table class="w-full text-left bg-white dark:text-gray-200 dark:bg-gray-500">
                <thead class="bg-gray-200 dark:text-gray-200 dark:bg-gray-600">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-center">{{ __('Vacaciones') }}</th>
                ...
                <tbody>
                    ...
                    <tr class="border-t">
                       ...
                       <td class="text-center px-4 py-2 text-blue-600 dark:text-blue-900">
                         <a href="{{ route('vacaciones-employee', $empleado->id) }}" class="hover:underline">
                       Ver vacaciones </a></td>
