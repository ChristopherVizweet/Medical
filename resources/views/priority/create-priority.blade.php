...
<x-guest-layout>  
    <form method="POST" action="{{ route('store-priority') }}">
        @csrf
        ...
        <div class="mt-4">
            ...
            <x-text-input id="namePriority" class="block mt-1 w-full is-invalid " autocomplete="off" type="text" name="namePriority" :value="old('namePriority')" required />
            <x-input-error :messages="$errors->get('namePriority')" class="mt-2 is-invalid" />
        </div>
