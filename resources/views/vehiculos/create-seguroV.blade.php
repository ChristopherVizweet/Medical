<x-guest-layout>
    <form method="POST" action="{{ route('store-seguroV',$vehiculos->id) }} " enctype="multipart/form-data">
        @csrf
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-slate-200" data-fg-d3bl21="0.8:1.26440:/src/app/App.tsx:145:11:4157:8332:e:div:ete" data-fgid-d3bl21=":rm:">
            <h2 class="text-2xl text-slate-800 mb-6 pb-4 border-b border-slate-200" data-fg-d3bl22="0.8:1.26440:/src/app/App.tsx:146:13:4246:135:e:h2:t" data-fgid-d3bl22=":rn:">Registro de pago del Seguro</h2>
            <form class="space-y-6" data-fg-d3bl24="0.8:1.26440:/src/app/App.tsx:150:13:4395:8077:e:form:ete" data-fgid-d3bl24=":ro:">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" data-fg-d3bl25="0.8:1.26440:/src/app/App.tsx:151:15:4462:7254:e:div:xtetxte" data-fgid-d3bl25=":rp:">
                    <div class="lg:col-span-1" data-fg-d3bl27="0.8:1.26440:/src/app/App.tsx:153:17:4583:1814:e:div:ete" data-fgid-d3bl27=":rq:">
                        <label class="block text-sm text-slate-700 mb-2" data-fg-d3bl28="0.8:1.26440:/src/app/App.tsx:154:19:4633:84:e:label:t" data-fgid-d3bl28=":rr:">Fotografia del comprobante de pago</label>
                        <div class="border-2 border-dashed border-slate-300 rounded-xl p-4 text-center hover:border-slate-400 transition-colors" data-fg-d3bl30="0.8：1.26440:/src/app/App.tsx：155：19：4736：1638：e：div：x" data-fgid-d3bl30="：rs：">
                            <label class="cursor-pointer block" data-fg-d3bl36="0.8：1.26440：/src/app/App.tsx：172：23：5662：664：e：label：ete" data-fgid-d3bl36="：rt：">
                                ...
                                <input id="comprobante_pago_seguro" type="file" name="comprobante_pago_seguro" class="hidden">
                                @if ($vehiculos->comprobante_pago_seguro == null)
                    ...
                    <div class="lg:col-span-2 grid grid-cols-1 grid-col-2 md:grid-cols-2 gap-4" data-fg-d3bl45="0.8:1.26440:/src/app/App.tsx:190:17:6464:5231:e:div:etetetetetetete" data-fgid-d3bl45=":r13:">
                        <div Onlyread="true" >
                            ...
                            <input onlyread="true" type="text" class="w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none" value="{{ $vehiculos->nombre_vehiculo ?? 'Sin nombre' }}">
                        </div>
                        <div>
                            <label class="block text-sm text-slate-700 mb-2 flex items-center gap-2" data-fg-d3bl47="0.8:1.26440:/src/app/App.tsx:192:21:6578:201:e:label:et" data-fgid-d3bl47=":r15:">
                                Nombre del seguro</label>
                            <!-- Campo donde aparece el nombre del vehiculo -->
                            <input name="empresa_seguro" onlyread="true" type="text" class="w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none">
                        </div>
                        <div class="">
                            <label class="block text-sm text-slate-700 mb-2 flex items-center gap-2" data-fg-d3bl47="0.8:1.26440:/src/app/App.tsx:192:21:6578:201:e:label:et" data-fgid-d3bl47=":r15:">
                                Número telefonico del seguro</label>
                            <!-- Campo donde aparece el nombre del vehiculo -->
                            <input maxlength="10" name="telefono_seguro" onlyread="true" type="number" class="w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none">
                        </div>
                        <div class="">
                            <label class="block text-sm text-slate-700 mb-2 flex items-center gap-2" data-fg-d3bl47="0.8:1.26440:/src/app/App.tsx:192:21:6578:201:e:label:et" data-fgid-d3bl47=":r15:">
                                Correo electronico del seguro</label>
                            <!-- Campo donde aparece el nombre del vehiculo -->
                            <input name="correo_seguro" onlyread="true" type="email" class="w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none">
                        </div>
                        <div>
                            <label class="block text-sm text-slate-700 mb-2 flex items-center gap-2">
                                Monto pagado</label>
                            <input name="monto" type="number" step="0.01" class="w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none">
                        </div>
                        <div>
                            <label class="block text-sm text-slate-700 mb-2 flex items-center gap-2" data-fg-d3bl47="0.8:1.26440:/src/app/App.tsx:192:21:6578:201:e:label:et" data-fgid-d3bl47=":r15:">
                                Fecha pagada</label>
                            <input name="fecha_pago_seguro" type="date" class="border border-slate-300 w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none">
                        </div>
                        
                        <div>
                            <label class="block text-sm text-slate-700 mb-2 flex items-center gap-2" data-fg-d3bl47="0.8:1.26440:/src/app/App.tsx:192:21:6578:201:e:label:et" data-fgid-d3bl47=":r15:">
                                Fecha proxima de pago</label>
                            <input name="fecha_proxima_seguro" type="date" class="col-span-2 border border-slate-300 w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none">
                        </div>
                        <div>
                            <label class="block text-sm text-slate-700 mb-2 flex items-center gap-2" data-fg-d3bl47="0.8:1.26440:/src/app/App.tsx:192:21:6578:201:e:label:et" data-fgid-d3bl47=":r15:">
                                Fecha que expira</label>
                            <input name="fecha_expirar_seguro" type="date" class="col-span-2 border border-slate-300 w-full px-4 py-3 focus:ring-2 focus:ring-slate-500 focus:border-transparent outline-none">
                        </div>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    const input = document.getElementById('comprobante_pago_seguro');
