<x-guest-layout>
    ...
    <form method="POST" action="{{ route('store_supplier') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phoneNumber_supplier" class="block mt-1 w-full" autocomplete="off" type="tel" name="phoneNumber_supplier" :value="old('phoneNumber_supplier')" required placeholder="Ej. 5532581234" />
