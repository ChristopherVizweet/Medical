...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/pdf-tenencias/{id}', [App\Http\Controllers\VehiculoTenenciasController::class, 'print'])->name('pdf-tenencias');
    // Seguro de vehiculos
    ...
    Route::get('/pdf-seguroV/{id}', [App\Http\Controllers\SeguroVehiculoController::class, 'print'])->name('pdf-seguroV');
    ...
    Route::get('/pdf-verificaciones/{id}', [App\Http\Controllers\VerificacionVehiculoController::class, 'print'])->name('pdf-verificaciones');
