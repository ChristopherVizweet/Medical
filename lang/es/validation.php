...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'cantidad' => [
            ...
            'max' => 'No hay suficiente stock disponible.',
        ],
        'cantidadR' => [
            'required' => 'Debe especificar la cantidad requerida.',
            'numeric' => 'La cantidad requerida debe ser un número.',
            'min' => 'La cantidad requerida debe ser mayor a cero.',
        ],
        'cantidadA' => [
            'required' => 'Debe especificar la cantidad aprobada.',
            'numeric' => 'La cantidad aprobada debe ser un número.',
            'min' => 'La cantidad aprobada debe ser mayor a cero.',
            'lte' => 'La cantidad aprobada no puede ser mayor que la cantidad requerida.',
        ],
        'stock' => [
        ...
        'productos.*.product_id' => [
            'required' => 'Debe seleccionar un producto para cada línea.',
            'exists' => 'Uno de los productos seleccionados no existe.',
        ],
        'productos.*.cantidad' => [
            'required' => 'Debe especificar una cantidad para cada producto.',
            'numeric' => 'La cantidad debe ser un número.',
            'min' => 'La cantidad debe ser mayor a cero.',
            'max' => 'No hay suficiente stock disponible.',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'obra_movimiento' => 'obra',
        'empleado_id' => 'solicitante',
        'fecha_movimiento' => 'fecha',
        'observaciones_movimiento' => 'observaciones',
        'product_id' => 'producto',
        'cantidad' => 'cantidad',
        'cantidadR' => 'cantidad requerida',
        'cantidadA' => 'cantidad aprobada',
